...
@php
    ...
    $areas = [
        'backend' => [
            'label' => ['es' => 'Backend & lenguajes', 'en' => 'Backend & languages'],
            'accent' => '#3b82f6',
        ...
        'data' => [
            'label' => ['es' => 'Datos & APIs', 'en' => 'Data & APIs'],
            'accent' => '#a78bfa',
        ...
        'erp' => [
            'label' => ['es' => 'ERP, CMS & ecommerce', 'en' => 'ERP, CMS & ecommerce'],
            'accent' => '#34d399',
        ...
        'infra' => [
            'label' => ['es' => 'Infraestructura & DevOps', 'en' => 'Infrastructure & DevOps'],
            'accent' => '#fbbf24',
        ...
        'tools' => [
            'label' => ['es' => 'Entorno & metodología', 'en' => 'Environment & methodology'],
            'accent' => '#38bdf8',
